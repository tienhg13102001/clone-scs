    ...
    return (
        <>
            ...
            <p className="text-xl text-[#444444] font-medium mt-5 mx-2 md:mx-0">
                ...
                continuously monitor and <br /> analyze the perfor- mance and
                efficiency of green energy systems. <br />
                <br />
                It supports real-time optimized operations, It de- tects
                problems in advance and responds quickly.
            </p>
