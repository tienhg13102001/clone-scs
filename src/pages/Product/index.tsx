      ...
      <main className="min-h-screen w-full">
        ...
        >
          <div className="flex flex-col items-center justify-center pt-[150px]">
            <p className="text-white text-[50px] capitalize text-custom">
              {t("products.main_path")}
            </p>
            <div className="flex gap-[15px] mt-[100px]">
          ...
          <Container>
            ...
            <div className='flex flex-row gap-6'>
              ...
              <div className='flex flex-col gap-2 mt-16'>
                <div className='flex flex-row gap-4'>
                  <p className="2xl:text-4xl text-xl font-semibold">{t("products.item5.name")}</p>
                  <span className="border-t-4 flex-grow border-black mt-4"></span>
                </div>
                <p className='text-[#444] text-xl'>{t("products.item5.content1")}</p>
                <p className='text-[#444] text-xl mt-5'>{t("products.item5.content2")}</p>
                <img src={Product5} className='h-[300px] w-full md:h-[400px] lg:h-[650px] object-contain mt-5' />
              </div>
            </div>
          </Container>
        </section>
